...
public class MypointDAO {
	...
	public int p_updateUrl(int f_seq) {
		return sqlSession.update("mypoint.p_updateUrl", f_seq);
	}
	
	public int p_updateUrl2(int rv_seq) {
		return sqlSession.update("mypoint.p_updateUrl2", rv_seq);
	}
	
	public int p_supdateUrl(int slog_seq) {
		return sqlSession.update("mypoint.p_supdateUrl", slog_seq);
	}
}
