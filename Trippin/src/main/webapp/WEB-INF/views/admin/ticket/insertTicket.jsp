                ...
                <div class="main-detail">
                    <form method="post" enctype="multipart/form-data">
                            	...
                            	<div class="cate_area1">
	                            	<select name="ticket_cate_no" id="tcn">
	                            		...
	                            		<c:forEach var="tc" items="${tclist }">
	                            			<option value="${tc.ticket_cate_seq }">${tc.ticket_cate_name }</option>
	                            		</c:forEach>
	                            	</select>
                            	</div>
                            	<div class="cate_area1">
                        ...
                        <div class="mi-one">
                            ...
                            <div class="input-one">
                                <input type="text" name="ticket_intro">
                                <div class="io-info">
                        ...
                        <div class="mi-one">
                            ...
                            <div class="input-two2"> 
                                <input type="radio" name="voucher" value="0" class="candy" id="now" onclick="hereVoucher();"><label for="now">즉시 제공</label>
                                <input type="radio" name="voucher" class="candy" id="time" onclick="hereVoucher();">
                                <label for="time" style="padding-right: 0%;">최대</label> <input type="number" class="candy" name="voucher" id="vouchertime" min="0"><label for="time">시간 소요</label>
                            </div>
                            <div class="disable">
                        ...
                        <div class="mi-one">
                            ...
                            <div class="input-two2">
                                <textarea name="more_info" rows="20px" cols="62px" class="more_info">
                                	==업체 정보==
									==상품 문의 연락처==
									==이용 정보==
									==고객 센터 정보==
