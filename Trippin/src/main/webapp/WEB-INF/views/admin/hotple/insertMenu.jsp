...
<div class="main">
	<form action="${cpath }/admin/hotple/insertMenu" method="post" enctype="multipart/form-data" onsubmit="return check(this)">
        <input type="hidden" name="f_seq" value="${param.f_seq }">
        <div class="mi-one">
                ...
                <div class="menu-item">
                    <div class="mi-one">
                        ...
                        <div class="" style="margin-left: 14.09%; margin-top: 1.5%;">
                            <input type="file" name="photo" class="menu-image"/>
                        </div>
                    </div>
                    <div class="mi-one">
                    ...
                    <div class="menu-btnz" style="height:20px;">
                    	<!-- 빈 공간 -->
                    </div>
                </div>
            </div>
