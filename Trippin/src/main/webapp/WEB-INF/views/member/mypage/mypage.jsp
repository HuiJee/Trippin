            ...
            <header class="header">
                <div class="inner">
                    <div class="head-title">
                        <span onclick="document.location.href='${cpath}/'" style="cursor: pointer;">TRIPPIN<img src="https://cdn-icons-png.flaticon.com/128/7291/7291011.png"></span>
                    </div>
                </div>
            </header>
            <div class="main">
                            ...
                            <div class="member-info">
                                <div class="member-main">
                                    <div class="mem-text">
                                        ...
                                        <div class="mem-count">
                                            <div class="mc-1" onclick="window.open('${cpath }/member/benefit/point','마이포인트','width = 500px, height=600px, top=300px, left=300px, scrollbars=yes')">
                                            	마이 포인트 <span><fmt:formatNumber value="${mypoint }" pattern="#,##0" /></span>p</div>
                                            <div class="mc-2">소멸 예정 캐시 <span><fmt:formatNumber value="${canUse }" pattern="#,##0" /></span>원</div>
                                        </div>
                                    </div>
                                    <div class="mem-btn">
                                        <div class="btn-info">
                                ...
                                <div class="member-reward">
                                    <div class="use-reward">
                                        ...
                                        <div class="ur-detail" onclick="window.open('${cpath }/member/benefit/cash','마이캐시','width = 500px, height=600px, top=300px, left=300px, scrollbars=yes')">
                                            <span><fmt:formatNumber value="${canUse }" pattern="#,##0" /></span>캐시
                                        </div>
                                    </div>
                                    ...
                                    <div class="use-jjim">
                                        ...
                                        <div class="uj-detail">
                                            <span onclick="popJJIM()">${myJJIMlist.size() }건</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
