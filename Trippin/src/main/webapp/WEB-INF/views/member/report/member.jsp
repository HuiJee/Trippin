    ...
    <html lang="kr">
        ...
        <body>
            <header class="header">
                <div class="inner">
                    <div class="hd-in">
                        <img src="https://img.freepik.com/premium-vector/police-alarm-or-emergency-siren-icon_153791-1113.jpg">
                        <span>신고하기</span>
                    </div>
                </div>
            </header>
            <div class="main">
                <form action="${cpath }/member/report/m_insert" method="post" onsubmit="return check(this)" enctype="multipart/form-data">
                    <input type="hidden" name="bad_seq" value="${param.bad }">
                    <div class="main-top">
                        <div class="s-top">
                            <div class="s-title">
                                <span>사유 선택</span>
                            ...
                            <div class="s-box">
                                <select class="m-select" name="m_report_cate_seq">
                                    <option value="" disabled selected>사유를 선택해주세요.</option>
                                    <c:forEach var="m" items="${list }">
                                        <option value="${m.m_report_cate_seq }">${m.m_report_cate_name }</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                        <div class="e-top">
                            ...
                            <div class="e-input">
                                <input class="inemail" type="email" name="email" placeholder="이메일을 입력해주세요.">
                            </div>
                        </div>
                    </div>
                    <div class="main-mid">
