...
<!DOCTYPE html>
    <html lang="kr">
        ...
        <body>
            ...
            <div class="main">
                <form action="${cpath }/member/sreport/s_insert" method="post" onsubmit="return check(this)" enctype="multipart/form-data">
                   ...
                   <input type="hidden" name="kind" value="${kind}" >
                    <div class="main-top">
                        <div class="s-top">
                            ...
                            <div class="s-box">
                                <select class="m-select" name="report_cate_seq">
                                    <option value="" disabled selected>사유를 선택해주세요.</option>
                                    <c:forEach var="m" items="${rclist }">
                                        <option value="${m.report_cate_seq }">${m.report_cate_name }</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
