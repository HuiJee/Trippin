            ...
            <script type="text/javascript">
            	...
            	function addnewplace(f){
	            	...
	            	if(name == ''){
	            		...
	            		alert("이 장소의 특징을 설명해주세요.");
	            		f.reason.focus();
	            		return;
	            		console.log("어????");
	            	}else{
	        			f.action = "${pageContext.request.contextPath }/member/newplace/npCheck";
	            		console.log("잉????");
	        			f.submit();
	        		}
                ...
                <form enctype="multipart/form-data" method="post">
                    <div class="main-top">
                        <div class="mt-1">
                            ...
                            <div class="mt-input">
                                <input class="mtit" type="text" name="name">
                            </div>
                        </div>
                        <div class="mt-2">
                            <div class="mt2-name">
                        ...
                        <div class="mt-3" style="margin-top : 3%;">
                            ...
                            <div class="mt3-stitle">
                                ...
                                <textarea class="mt3-area" placeholder="특징 또는 추천 이유를 입력해주세요." name="reason"></textarea>
                            </div>
                        </div>
                        <div class="mt-4">
                            <div class="mt4-title">
                                ...
                                <div class="mt4t-stitle">
                                    메뉴 및 이용료, 외관/내관 사진 등 장소를 확인할 수 있는 추가정보를 알려주세요.<br>사진은 직접 촬영한 사진 또는 공식 홈페이지 사진만 사용할 수 있습니다.
                                </div>
                                <label class="popimg-co" for="popup1"><img id="pimg" class="popimg" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS3-ywUVHBNam3DS8gXfLDGYf7lpS98npeAhw&usqp=CAU" alt=""></label>
                                <input type="checkbox" id="popup1" onclick="updown(this)">
                                ...
                                <div id="menus">
                                    <div class="menu">
                                        <div class="mi-one">
                                            ...
                                            <div class="mi-sname">
                                                간판이 보이는 외관 사진 및 내관 사진을 추가해주세요.
                                            </div>
                                            <div class="mi-imginput">
                                                <label for="file">
                                                    <div class="iu-custom">
                                                        <img src="imgupload.png">
                                                    </div>
                                                </label>
                                                <input type="file" name="files" id="files" multiple="multiple" style="margin-left : 10%; margin-top : 10%;"/>
                                            </div>
                                        </div>
                                        <script>
                                            function updown(t) {
                                                const btn = document.getElementById("pimg");
                                        ...
                                        <div class="mi-one">
                                            ...
                                            <div class="mi-sname">
                                                맛집은 메뉴판/대표 메뉴 가격을, 관광지는 서비스 이용료를 알려주세요.
                                            </div>
                                            <textarea placeholder="내용을 입력해주세요." name="info"></textarea>
                                            <div class="mi-imginput">
                                                <label for="file">
                                                    <div class="iu-custom">
                                                        <img src="imgupload.png">
                                                ...
                                                <input type="file" name="files2" id="files2" multiple="multiple" style="margin-left : 10%; margin-top : 10%;"/>
                                            </div>
                                        </div>
                                        <div class="mi-one">
                                            <div class="mi-name">
                                            ...
                                            <div class="mi-sname">
                                                예약 가능 여부, 한국어 가능 직원 여부, 해피아워 등 제공되는 서비스의 자세한 내용을 알려주세요.
                                            </div>
                                            <textarea placeholder="내용을 입력해주세요." name="services"></textarea>
                                        ...
                                        <div class="mi-one">
                                            ...
                                            <div class="mi-sname">
                                                홈페이지, 구글 장소 url 등 장소에 대한 기타 내용을 알려주세요.
                                            </div>
                                            <textarea placeholder="내용을 입력해주세요." name="extra"></textarea>
                        ...
                        <div class="mt-5">
                            ...
                            <div class="mt5-stitle">
                                입력해주신 이메일로 등록 검토 결과를 알려드립니다.
                        ...
                        <div class="mt-6">
                            ...
                            <div class="mt6-stitle">
                                <div class="mt6sz">장소 등록 검토 결과 안내를 위해 이메일을 수집하며, 1년간 보관후 파기됩니다.</div>
                        ...
                        <div class="mt-7">
                            <div class="mt7-submit">
                                <input class="mt7s" type="button" value="완료" onclick="addnewplace(this.form);">
                            </div>
                        </div>
                    </div>
                    <input type="hidden" name="email_status" id="e_status">
                </form>
            </div>
