...
<!DOCTYPE html>
    <html lang="kr">
        ...
        <script type="text/javascript">
        function selectTourTicket(f) {
            //console.log(f.id);
            
            var target=document.getElementById("resultDiv");
            var param= "m_seq="+f.id;
            var url="${pageContext.request.contextPath}/member/cs/selectTicket";
                ...
                if(xhr.readyState === 4 && xhr.status === 200){
                    ...
                    if(data.length !=0){  //''이거 안됨 0으로 하기
                       ...
                       /*  var br1 = document.createElement("br");
                        ...
                        reservationRadio.name="t_purchase_seq";
                        reservationRadio.value=result[i]["t_purchase_seq"];
                       ...
                       // reservationDiv.appendChild(br2);
                        ...
                        usageInfo.innerText="이용예정:"+result[i]["use_date"];
                       ...
                       // reservationDiv.appendChild(br4);
                        ...
                        alert("투어티켓 예약정보가 없습니다.예약정보가 없어도 문의가 가능합니다.");
                    }
                }
            },
                "POST");
        ...
        function insert(f) {
            ...
            if(cateKind ==='9' && purchase_no ==='0'){
                alert("취소환불 문의일 경우 예약정보를 선택하세요!");
                return false;
            }
        ...
        <body>
            <div class="header">
                <span>티켓 1:1문의 페이지</span>
            </div>
            <form action="${cpath}/member/cs/tInsert" method="post" enctype="multipart/form-data" onsubmit="return insert(this)">
                <div class="main" align="center">

                    <input type="hidden" name="cs_cate_seq" value="2">
                    <input type="hidden" name="kind" value="1">
                    <input type="hidden" id="purchase_no" name="purchase_no" value="0">
                    ...
                    <div class="table">
                        <div class="tb-1">
                            ...
                            <div class="t1-text">
                                ...
                                <c:forEach var="sl" items="${csSubCateList2 }" >
                        ...
                        <div class="tb-1">
                            ...
                            <div class="t1-text">
                                <input type="button" value="투어·티켓예약번호 조회하기" id="${login }"  onclick="selectTourTicket(this);">
                                <!-- 예약정보 있으면 -->
                                <div id="resultDiv">
