        ...
        <body>       
            ...
            <header class="header">
                <div class="inner">
                    <div class="hd-in">
                        <div class="hd-left">
                            <img style="cursor: pointer;" onclick="history.back()" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTLjuQtoYJv9cnr8l1xXoOflCBGLP_jFwS1hw&usqp=CAU">
                        </div>
                        <div class="hd-mid">
            ...
            <div class="main">
                ...
                <form class="main-ex"  id="travel-form" action="${pageContext.request.contextPath }/schedule/sche/edit/editCity" method="POST">
                    <div class="me-top">
