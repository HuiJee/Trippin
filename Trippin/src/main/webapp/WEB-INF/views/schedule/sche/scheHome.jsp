        ...
        <form action="${pageContext.request.contextPath }/" id="scheHomeForm" method="post">
            ...
            <header>
                ...
                <div class="outer">
                    <div class="ot-list">							
                        <a href="#"><div>숙소</div></a>
                        <a href="${cpath }/member/selectList?cate_seq=1"><div>관광</div></a>
                        <a href="${cpath }/member/selectList?cate_seq=2"><div>맛집</div></a>
                        <a href="${cpath }/member/selectTKlist"><div>투어·티켓</div></a>
